...
__IO uint16_t uhADCxConvertedData_Voltage_mVolt[ADC_BUF_LENGTH];        /* Value of voltage on GPIO pin (on which is mapped ADC channel) calculated from ADC conversion data (unit: mV) */
